...
# Save to Dict
with open('text_analysis/results/all_message_embeddings_final.pkl', 'rb') as file:
...
final_data.to_csv('text_analysis/results/diversity_metrics_all_messages_final.csv')
...
diversity_metric = pd.read_csv(
    'text_analysis/results/diversity_metrics_all_messages_final.csv')
...
merged_data.to_csv('text_analysis/results/diversity_w_superficial_all_messages_final.csv')
