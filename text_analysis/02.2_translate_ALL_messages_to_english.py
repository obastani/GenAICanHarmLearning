...
# Load data
user_messages = pd.read_csv('text_analysis/data/all_user_messages_raw_s1_4_final.csv')

# Assume this is not the first run, we can load translated messages
...
# save
final_result.to_csv('text_analysis/data/translated_all_messages_s1_4_final.csv')
