...
# Preparedata
# ================
raw_data = pd.read_csv('text_analysis/data/translated_all_messages_s1_4_final.csv', dtype=str)
...
for group in group_id_list:
    ...
    topic_model.save(f"text_analysis/model_checkpoints/s1_4/checkpoint_{group}_ALL_messages_full",
                     serialization="pickle")
    topic_model.save(f"text_analysis/model_checkpoints/s1_4/checkpoint_{group}_ALL_messages_light",
                     serialization="safetensors")
    results_corrected.to_csv(
        f'text_analysis/data/all_message_cluster_by_arm_grade/first_prompt_cluster_result_{group}_s1_4_ALL_messages_final.csv')
