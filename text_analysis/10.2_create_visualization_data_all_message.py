...
data = pd.read_csv('text_analysis/results/meta_cluster_all_messages_final.csv')
...
# all_relevant_clusters = top_3_clusters_for_each_session['meta_rep_doc'].isin(all_unique_clusters)
...
relabel_mapping = {
    ...
    'how many numbers between 24 and 150 that is product of 4': 'Attempted Answers',
    'is the answer 1': 'Attempted Answers',
    'no': 'Attempted Answers',
    'i cant do it help': 'Ask for Help',
    'solve this': 'Ask for Help'
}
...
aug_plot_data.to_csv('text_analysis/results/augmented_top3_clusters_final_all_messages.csv')
van_plot_data.to_csv('text_analysis/results/vanilla_top3_clusters_final_all_messages.csv')
