...
# Load the data
relabeled_cluster = pd.read_csv('text_analysis/results/relabeled_cluster_first_messages_final.csv')

relabeled_cluster_naomit = relabeled_cluster[~relabeled_cluster['repdoc'].isna(
...
topics, probs = topic_model.fit_transform(
    relabeled_cluster_naomit['relabeled_topic'])


# Get results
results = topic_model.get_document_info(
    relabeled_cluster_naomit['relabeled_topic'])
...
topic_model.save("text_analysis/model_checkpoints/meta_cluster/full_model",
                 serialization="pickle")
topic_model.save("text_analysis/model_checkpoints/meta_cluster/light_model",
...
relabeled_cluster_naomit.to_csv('text_analysis/results/meta_cluster_first_messages_final.csv')


# ==============================
# Find most common questions
# ==============================
relabeled_cluster_naomit = pd.read_csv('text_analysis/results/meta_cluster_first_messages_final.csv')
